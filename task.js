 ...
 */
let users = [
  {name: "Farida Afrina",   age: 20, major: "Teknik Informatika"},
  {name: "Dina Annisa",     age: 19, major: "Sistem Informasi"},
  {name: "Rico Sanjaya",    age: 21, major: "Bisnis Digital"},
  {name: "Intan Aulia",     age: 20, major: "Sistem Informasi"},
  {name: "Sari Maulidiyah", age: 21, major: "Teknik Informatika"},
];
